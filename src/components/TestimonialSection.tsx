      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="flex items-center justify-center mb-8">
          ...
          <div className="text-left">
            <h3 className="font-semibold text-lg">Lindsay Stanton</h3>
            <p className="text-white/80">Author & Grief Coach</p>
          </div>
        </div>

        <div className="space-y-8">
          <p className="uppercase tracking-wide font-semibold text-sm text-white/90">
            CREATE CLOSER CONNECTIONS
          </p>
          <h2 className="text-4xl lg:text-5xl font-bold leading-tight">
            Swarm brings your community
            closer than ever before through
            bite-sized video exchanges.
          </h2>
        </div>
      </div>
