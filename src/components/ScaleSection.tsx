  ...
  return (
    <section className="bg-primary text-white py-20 relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <p className="uppercase tracking-wide font-semibold text-sm mb-8 text-white/90">
          BUILT FOR SCALE
        </p>
        <h2 className="text-4xl lg:text-6xl font-bold leading-tight mb-8">
          Start a hassle-free side hustle or
          build a 100+ membership.
          <br />
          <span className="text-white/90">Swarm scales with you.</span>
        </h2>
      </div>
